...
//     if (this.parentElement.parentElement.children[0].innerText === exercises[i].exercise.trim() && this.parentElement.parentElement.children[1].innerText === exercise[i].calories.trim()) {
//       this.parentElement.parentElement.remove();
//
//       exercises.splice(i,1)
//       exercisesJSON = JSON.stringify(foods);
...
$(document).ready(function(){
  ...
  event.preventDefault();
    var exercises = JSON.parse(localStorage["exercises"])
    for (var i = 0; i < exercises.length; i++) {
      if (this.parentElement.parentElement.children[0].innerText === exercises[i].exercise.trim() && this.parentElement.parentElement.children[1].innerText === exercises[i].calories.trim()) {
