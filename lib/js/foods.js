  ...
  function storeFood(food, calories) {
    ...
    // nsjdfnjfdsnjfsjknfnkjsfdkjnfsdnjkfdsjknfsdjknsdfkjnfsdknjsdfknjfdskjfsdkjndsfjkndsfknjfsdkjnsdfjkn
  ...
  function updateTable() {
    // add element.id to arguments
    // store element id into each table row
    // use id in table row to match to id in local storage
    // reverse some shit somewhere
